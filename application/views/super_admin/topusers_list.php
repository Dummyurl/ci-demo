                            ...
                            <div class="page-header light-fg row no-gutters align-items-center justify-content-between">
                                <div class="col-12 col-sm">
                                    <div class="logo row no-gutters justify-content-center align-items-start justify-content-sm-start">
                                        ...
                                        <div class="logo-text">
                                            <div class="h4">Top Users List</div>
                                            <div class="">Total Top Users: <?php echo count($records); ?></div>
                                        </div>
                                    </div>
                                </div>
                                <!-- <form method="post" action="<?php echo base_url("super_admin/users/topusers"); ?>">
                                        ...
                                        <table id="sample-data-table" class="table">
                                                        ...
                                                        <nav aria-label="...">
                                                            ...
                                                            <?php    
                                                                    ...
                                                                    <li class="page-item">
                                                                        <a class="page-link" href="<?php echo base_url('super_admin/users/topusers').'/'.$prev;?>">Previous</a>
                                                                    </li>
                                                                    <li class="page-item"><a class="page-link" href="<?php echo base_url('super_admin/users/topusers').'/'.$prev;?>">1</a></li>
                                                                <?php 
                                                                }
                                                                    for($i=1;$i<=$count-1;$i++) {
                                                                        if($i > $id-4 AND $i < $id+4 ){
                                                                                ...
                                                                                <?php }else{ ?>
                                                                                    <li class="page-item">
                                                                                <?php } ?>
                                                                                    <a class="page-link" href="<?php echo base_url('super_admin/users/topusers').'/'.$i;?>"><?php echo $i+1 ?></a>
                                                                                </li>
                                                                                <?php
                                                                                    }
                                                                                } $next = $id+1; ?>
                                                                                <li class="page-item">
                                                                                    <a class="page-link" href="<?php echo base_url('super_admin/users/topusers').'/'.$next;?>">Next</a>
                                                                                </li>
                                                                        <?php   }
                                                                        ?>
                                                                    </ul>
