<script> function account(val) { window.location = "<?php echo base_url();?>super_admin/users/index_deactive?search" + val; } </script>
                            ...
                            <div class="page-header light-fg row no-gutters align-items-center justify-content-between">
                                <div class="col-12 col-sm">
                                    <div class="logo row no-gutters justify-content-center align-items-start justify-content-sm-start">
                                        ...
                                        <div class="logo-text">
                                            <div class="h4">Detive Users List</div>
                                            <div class="">Total Deative Users: <?php echo count($records); ?></div>
                                        </div>
                                    </div>
                                </div>
                                <form method="post" action="<?php echo base_url("super_admin/users/index_deactive"); ?>">
                                                   ...
                                                   <table id="sample-data-table" class="table">
                                                         ...
                                                         <nav aria-label="...">
                                                            ...
                                                            <?php    
                                                                    ...
                                                                    <li class="page-item">
                                                                        <a class="page-link" href="<?php echo base_url('super_admin/users/index_deactive').'/'.$prev;?>">Previous</a>
                                                                    </li>
                                                                    <li class="page-item"><a class="page-link" href="<?php echo base_url('super_admin/users/index_deactive').'/'.$prev;?>">1</a></li>
                                                                <?php 
                                                                }
                                                                    for($i=1;$i<=$count-1;$i++) {
                                                                        if($i > $id-4 AND $i < $id+4 ){
                                                                                ...
                                                                                <?php }else{ ?>
                                                                                    <li class="page-item">
                                                                                <?php } ?>
                                                                                    <a class="page-link" href="<?php echo base_url('super_admin/users/index_deactive').'/'.$i;?>"><?php echo $i+1 ?></a>
                                                                                </li>
                                                                                <?php
                                                                                    }
                                                                                } $next = $id+1; ?>
                                                                                <li class="page-item">
                                                                                    <a class="page-link" href="<?php echo base_url('super_admin/users/index_deactive').'/'.$next;?>">Next</a>
                                                                                </li>
                                                                        <?php   }
                                                                        ?>
                                                                    </ul>
...
<script type="text/javascript">
    $(document).ready(function (e) {
        $("#deactive_users a").addClass('active');
    });
    ...
    function dlt_user(user_id) {
        var pass = prompt("Please enter password", "Password hear...");
        if (pass == 'delete') {
            $.ajax({
                type: 'POST',
